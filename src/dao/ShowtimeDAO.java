...
public class ShowtimeDAO {
    ...
    public List<Showtime> getShowtimesForMovie(int movieId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            LOG.log(Level.SEVERE, "Failed to fetch showtimes for movie_id=" + movieId, e);
        }
        return showtimes;
    }
    ...
    public List<Showtime> getAllShowtimes() {
        List<Showtime> showtimes = new ArrayList<>();
        String sql = "SELECT * FROM showtimes ORDER BY show_time DESC";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql);
            ...
            LOG.log(Level.SEVERE, "Failed to fetch all showtimes", e);
        }
        return showtimes;
    }
    ...
    public List<Movie> getMoviesByCity(int cityId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            LOG.log(Level.SEVERE, "Failed to fetch movies for city_id=" + cityId, e);
        }
        return movies;
    }
    ...
    public List<Showtime> getShowtimesByTheatre(int theatreId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            LOG.log(Level.SEVERE, "Failed to fetch showtimes for theatre_id=" + theatreId, e);
        }
        return showtimes;
    }
